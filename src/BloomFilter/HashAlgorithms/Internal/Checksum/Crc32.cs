...
namespace BloomFilter.HashAlgorithms.Checksum
{
    ...
    /// </summary>
    internal class Crc32 : HashAlgorithm, IChecksum
    {
        ...
        /// </summary>
        public long Value => _current ^ crcXor;
        ...
        {
            _current = unchecked(crcTable[(_current ^ b) & 0xFF] ^ (_current >> 8));
        }
        ...
        /// <exception cref="ArgumentNullException">buffer</exception>
        /// <exception cref="ArgumentOutOfRangeException">offset - cannot be less than zero
        /// or
