...
namespace BloomFilter.HashAlgorithms.Checksum
{
    ...
    /// </summary>
    internal class Crc32u : HashAlgorithm, IChecksum
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Crc32u"/> class.
        /// </summary>
        public Crc32u()
        {
            HashSizeValue = 64;
        ...
        {
            _current = unchecked(crcTable[(byte)(((_current >> 24) & 0xFF) ^ b)] ^ (_current << 8));
        }
