...
/// </remarks>
internal sealed unsafe class XxHash3 : NonCryptoHashAlgorithm
{
    ...
    public XxHash3(ulong seed) : base(HashLengthInBytes)
    {
    ...
    public ulong GetCurrentHashAsUInt64()
    {
        ...
        else
        {
            ...
            {
                current = HashToUInt64(new ReadOnlySpan<byte>(buffer, (int)_state.TotalLength), _state.Seed);
            }
        }
