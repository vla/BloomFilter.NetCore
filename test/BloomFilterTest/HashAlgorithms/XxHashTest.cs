...
namespace BloomFilterTest.HashAlgorithms
{
    ...
    {
        [Theory]
        [MemberData(nameof(XxHash32TestData))]
        public void XxHash32_ToUInt32<ExpectedChecksum>(TestPayloadParameter<ExpectedChecksum> parameter)
        {
            ...
            {
                actual = XxHash32.HashToUInt32(parameter.TestPayload);
            }
            else
            {
                actual = XxHash32.HashToUInt32(parameter.TestPayload[range]);
            }

            var expected = (string)(object)parameter.ExpectedValue;

            $"0x{actual:X4}".Should().Be($"0x{expected}");
        }

        [Theory]
        [MemberData(nameof(XxHash32TestData))]
        public void XxHash32_Append<ExpectedChecksum>(TestPayloadParameter<ExpectedChecksum> parameter)
        {
            var range = parameter.TestRange;
            ...
            uint actual = hash.GetCurrentHashAsUInt32();
        ...
        [Theory]
        [MemberData(nameof(XxHash64TestData))]
        public void XxHash64_ToUInt64<ExpectedChecksum>(TestPayloadParameter<ExpectedChecksum> parameter)
        {
            var range = parameter.TestRange;
            ...
            if (range.Equals(Range.All))
            {
                actual = XxHash64.HashToUInt64(parameter.TestPayload);
            }
            else
            {
                actual = XxHash64.HashToUInt64(parameter.TestPayload[range]);
            }
        ...
        [Theory]
        [MemberData(nameof(XxHash64TestData))]
        public void XxHash64_Append<ExpectedChecksum>(TestPayloadParameter<ExpectedChecksum> parameter)
        {
            var range = parameter.TestRange;
            ...
            ulong actual = hash.GetCurrentHashAsUInt64();
        ...
        [Fact]
        public void XxHash3_ToUInt64()
        {
            var tests = XxHash3TestData();

            foreach (var test in tests)
            {
                var data = test.Ascii.ToUtf8Bytes();
                var actual = XxHash3.HashToUInt64(data, test.Seed);

                Assert.Equal(test.Hash, actual);
            }
        }

        [Fact]
        public void XxHash3_Append()
        {
            var tests = XxHash3TestData();

            foreach (var test in tests)
            {
                Span<byte> data = test.Ascii.ToUtf8Bytes();

                XxHash3 hash = new(test.Seed);
        ...
        [Fact]
        public void XxHash128_ToUInt64()
        {
            ...
            {
                var data = test.Ascii.ToUtf8Bytes();
                var actual = XxHash128.HashToHash128(data, test.Seed);

                Assert.Equal(new XxHash128.Hash128(test.HashLow, test.HashHigh), actual);
            }
        }

        [Fact]
        public void XxHash128_Append()
        {
            var tests = XxHash128TestData();
            ...
            foreach (var test in tests)
            {
                ...
                Assert.Equal(new XxHash128.Hash128(test.HashLow, test.HashHigh), hash.GetCurrentHashAsHash128());
            }
        }

        public static IEnumerable<object[]> XxHash32TestData()
        {
            yield return new object[] { new TestPayloadParameter<string>("abc"u8.ToArray(), "32D153FF") };
            yield return new object[] { new TestPayloadParameter<string>("313233343536".FromHex(), "B7014066") };
            yield return new object[] { new TestPayloadParameter<string>("3132333435363738393031323334353637383930".FromHex(), "2D0C3D1B") };
            yield return new object[] { new TestPayloadParameter<string>("313233343536373839303132333435363738393031".FromHex(), "8ED1B04E") };
        }

        public static IEnumerable<object[]> XxHash64TestData()
        {
            yield return new object[] { new TestPayloadParameter<string>("abc"u8.ToArray(), "44BC2CF5AD770999") };
            yield return new object[] { new TestPayloadParameter<string>("313233343536".FromHex(), "2B2DC38AAA53C322") };
            yield return new object[] { new TestPayloadParameter<string>("31323334353637383930313233343536373839303132333435363738393031323334353637383930".FromHex(), "5F3AF5E23EEB431D") };
            yield return new object[] { new TestPayloadParameter<string>("3132333435363738393031323334353637383930313233343536373839303132333435363738393031".FromHex(), "45A03ED59AB5CAD6") };
        }

        #region XxHash3TestData

        private static IEnumerable<(ulong Hash, ulong Seed, string Ascii)> XxHash3TestData()
        {
        ...
        #endregion XxHash3TestData

        #region XxHash128TestData

        private static IEnumerable<(ulong HashHigh, ulong HashLow, ulong Seed, string Ascii)> XxHash128TestData()
        {
